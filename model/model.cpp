...
//
//
//float eye_x = 100, eye_y = 200, eye_z = -500;	//视觉中心位置
...
//class Image{
//public:
//	int data[1024][1024][4];
//	
//	int height;
//	int width;
//}faxian,image[modelNum];
//
//struct GlobalLight {
//	float r=1;
//	float g=1;
...
//vector<my_face_homogeneous> skybox;
...
//
//float shadowColor[nearplane_height][nearplane_width][3] = {1};
//float shadowDepth[nearplane_height][nearplane_width] = {0};
...
//		/*cout << i / (image.width * n) << " " << i % (image.width * n) / n << " " << i % n << endl;*/
//		image.data[i / (image.width * n)][i % (image.width * n) / n][i % n] = (int)data[i];
//	}
//	stbi_image_free(data);
//	
//
//}
//void readMTL(struct ModelReflectivity mdelReflectivity[],Image image[], string url)
//{
//	ifstream file;
//
...
//			readImage(image[index], "./海中屋/" + str[1]);
//			//cout << image[index].width << " " << "./海中屋/" + str[1] << endl;
//			if (index == 28)
//			{
//				readImage(faxian, "./海中屋/Tex/shueimian_f.bmp");
//				
//			}
//		}
//		else if (s[0] == 'K' && s[1] == 'a')
...
//			/*float a;
//			int b;*/
//			curPoint.x = atof(str[1].c_str())*10;
//			curPoint.y = atof(str[2].c_str())*10;
//			curPoint.z = atof(str[3].c_str())*10;
//			/* b= rand() % 101;
//			a = (float)b/ 100;
//			curPoint.rgb.r = a;
//			b = rand() % 101;
...
//
//	readMTL(mdelReflectivity, image, "./海中屋/海中屋.mtl");
//
//	ifstream inFile("./海中屋/cmd.txt", ios::out | ios::binary);
//	if (!inFile)
//	{
//		cout << "error" << endl;
//	}
...
//	//pointLight[3].b = 1;
//
//	//mdelReflectivity[1].Kar = 0.5;
//	//mdelReflectivity[1].Kag = 0.1;
//	//mdelReflectivity[1].Kab = 0.1;
//	//mdelReflectivity[1].Kdr = 0.3;
//	//mdelReflectivity[1].Kdg = 0.3;
//	//mdelReflectivity[1].Kdb = 0.3;
//	//mdelReflectivity[1].Ksr = 0.1;
//	//mdelReflectivity[1].Ksg = 0.1;
//	//mdelReflectivity[1].Ksb = 0.1;
//	//mdelReflectivity[1].n = 200;
//
//	//mdelReflectivity[2].Kar = 0.1;
//	//mdelReflectivity[2].Kag = 0.4;
//	//mdelReflectivity[2].Kab = 0.1;
//	//mdelReflectivity[2].Kdr = 0.2;
//	//mdelReflectivity[2].Kdg = 0.2;
//	//mdelReflectivity[2].Kdb = 0.2;
//	//mdelReflectivity[2].Ksr = 0.4;
//	//mdelReflectivity[2].Ksg = 0.4;
//	//mdelReflectivity[2].Ksb = 0.4;
//	//mdelReflectivity[2].n = 100;
//	
//}
//
//
...
//						float nor_x = (faxian.data[index_y_left][index_x_left][0] * 1.0f / 255.0f - 0.5) +
//							(faxian.data[index_y_right][index_x_right][0] * 1.0f / 255.0f - 0.5);
//						float nor_y = (faxian.data[index_y_left][index_x_left][1] * 1.0f / 255.0f - 0.5) +
//							(faxian.data[index_y_right][index_x_right][1] * 1.0f / 255.0f - 0.5);
//						float nor_z = (faxian.data[index_y_left][index_x_left][2] * 1.0f / 255.0f - 0.5) +
//							(faxian.data[index_y_right][index_x_right][2] * 1.0f / 255.0f - 0.5);
...
//			
//			color[y][x][0] += Weight*image[num].data[int(image[num].height * (p1.fy))][ int(image[num].width *( p1.fx))][0]/255;
//			color[y][x][1] += Weight * image[num].data[int(image[num].height * ( p1.fy))][int(image[num].width * ( p1.fx))][1] / 255;
//			color[y][x][2] += Weight * image[num].data[int(image[num].height * ( p1.fy))][int(image[num].width * ( p1.fx))][2] / 255;
//			
//			
//			
//			
...
//	char c='1';
//	while (!inFile.eof()) {
//		if ((c=inFile.good())&&count<fileCount) {
//			count++;
//			
//		}
//		cout << c << endl;
